...
import { isString, camelCase, kebabCase, isArray, omit, get, isNaN, isNumber } from 'lodash';
...
const id = customAlphabet('abcdefghijklmnopqrstuvwxyz', 10);
...
export { clearElement, convertCssUnit, flattenObjectArray, getStyle, id, isElement, isEmptyString, isIntegerAndBetween, isIntegerAndGreaterThan, isIntegerAndLessThan, isNumberLike, isTwoCNChar, isValuableString, makeClassName, makeClassNameByUrl, makeName, makeNameByUrl, makeRandomName, notEmptyArray, pascalCase, px, safeArray, throwError, titleCase, warn };
